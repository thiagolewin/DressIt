...
import FilterModal from '../../components/contexts/FilterModal.jsx';
...
const Inicio = () => {
    ...
    const IrAFiltros = () => {
        navigateTo('/filtros'); // Redirige a la página de filtros
    };
    ...
    return (
        <section id='inicio'>
            ...
            <div className='articulos'>
                <button className='buttonLink' onClick={IrAFiltros}>Filtros</button>
